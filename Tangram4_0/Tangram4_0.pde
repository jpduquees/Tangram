...
void draw(){
  ...
  //Menu principal
    if (nivel==0){
      ...
      //BOTON INSTRUCCIONES
        ...
        textAlign(LEFT,CENTER);
        if (chooseGet == cuac+1 && mousePressed){
          nivel = 12;
        }
      //BOTON CREDITOS
        fill(cuec+1);
        ...
        textAlign(LEFT,CENTER);
        if (chooseGet == cuec+1 && mousePressed){
          nivel = 13;
        }
      //LETRERO TANGRAM
        textSize(100);
  ...
  //Interfaz de niveles  
    if (nivel==1){
      ...
      //DELIMITACION DE AREAS PARA SELECCION DEL NIVEL Y POSICION INCIAL DE FICHA EN CADA NIVEL
        //NIVEL 1
        if (mouseX>=140 &&mouseX<=255 && mouseY>=155 && mouseY<=285 && mousePressed){
            nivel=2;
            contadorNiveles=2;
        ...
        //NIVEL 2
        if (mouseX>=300 &&mouseX<=450 && mouseY>=155 && mouseY<=285 && mousePressed){
          nivel=3;
          contadorNiveles=3;
        ...
        //NIVEL 3
        if (mouseX>=490 &&mouseX<=620 && mouseY>=155 && mouseY<=285 && mousePressed){
          nivel=4;
          contadorNiveles=4;
        ...
        //NIVEL 4
        if (mouseX>=650 &&mouseX<=765 && mouseY>=155 && mouseY<=285 && mousePressed){
          nivel=5;
          contadorNiveles=5;
        ...
        //NIVEL 5
        if (mouseX>=790 &&mouseX<=920 && mouseY>=155 && mouseY<=285 && mousePressed){
          nivel=6;
          contadorNiveles=6;
        ...
        //NIVEL 6
        if (mouseX>=140 &&mouseX<=255 && mouseY>=325 && mouseY<=470 && mousePressed){
            nivel=7;
            contadorNiveles=7;
        ...
        //NIVEL 7
        if (mouseX>=300 &&mouseX<=450 && mouseY>=325 && mouseY<=470 && mousePressed){
            nivel=8;
            contadorNiveles=8;
        ...
        //NIVEL 8
        if (mouseX>=490 &&mouseX<=620 && mouseY>=325 && mouseY<=470 && mousePressed){
            nivel=9;
            contadorNiveles=9;
        ...
        //NIVEL 9
        if (mouseX>=650 &&mouseX<=765 && mouseY>=325 && mouseY<=470 && mousePressed){
            nivel=10;
            contadorNiveles=10;
        ...
        //NIVEL 10
        if (mouseX>=790 &&mouseX<=920 && mouseY>=325 && mouseY<=470 && mousePressed){
          nivel=11;
      ...
      //BOTON MENU
        ...
        text("MENU",500,550);
        textAlign(LEFT,CENTER);
        if(chooseGet==green+1 && mousePressed){
          nivel=0;
        }
  }
  ...
  if (nivel !=0 && nivel !=1 && nivel !=12 && nivel !=13){
    ...
    //BOTON MENU
      ...
      text("Menu", 925, 545);
      textAlign(LEFT,CENTER);
      if(chooseGet==(tMc+1)&& mousePressed){
         nivel=0;
      }
    //LETRERO NIVELES
      fill(tM2c+1);
      ...
      textAlign(LEFT,CENTER);
      if(chooseGet==(tM2c+1)&&mousePressed){
        nivel=1;
      }
    ...
    //RESTRICCION DE SALIDA, (EVITA QUE LAS FICHAS SE SALGAN DEL CAMPBASS)  
      ...
      if ( cuex<=-20 || cuey>=620 || cuey<=-20 || cuex>=1020){
        cuex = 900;
        cuey = 575;
      }
    ...
    // SISTEMA DE DETECCION DE PARTIDA GANADA
      ...
      //NOTIFICAIÓN Y ACCIONES AL RESPECTO
        if (win == true){
          if(nivel ==11){
            textSize(40);
